            ...
            <div className="layout">
                <div className="b-menu">
                    <div className="menu-close menu-close--indentation">
                        <img src="/img/menu-close.svg" className="menu-close__image" onClick={this.handleHideMenu}/>
                    </div>
                    <NavLink to="/" className="menu__logo menu__logo--indentation"><img src="/img/paymo.svg" /></NavLink>
                    <SidebarNav />
                </div>
                <div className="b-content">
                    <div className="b-header-mobile b-header-mobile--indentation">
                        <div className="b-header-mobile__left"><img src="/img/menu.svg" className="b-burger" onClick={this.handleShowMenu}/></div>
                        <div className="b-header-mobile__right"><NavLink to="/" className="menu__logo"><img src="/img/paymo.svg" className="menu__logo-image--small" /></NavLink></div>
                    </div>
                    {this.props.children}
